...
export class ProductsComponent implements OnInit {
  ...
  itemPerPage: number = 20; // يمكن تعديله حسب الحاجة
  totalProducts: number = 0; // غيرت الاسم ليكون أكثر وضوحًا
  ...
  ngOnInit() {
    this.route.params.pipe(
      ...
      next: (categoryId) => {
        ...
        this.currentPage = 1;
        this.products = [];
        console.log('Current Category ID in ProductsComponent:', this.currentCategoryId);
        if (categoryId !== null) {
